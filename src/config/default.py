...
_CN.MODEL.MATCH_COARSE.MATCH_TYPE = 'dual_softmax'  # options: ['dual_softmax, 'sinkhorn']
_CN.MODEL.MATCH_COARSE.DSMAX_TEMPERATURE = 0.1
_CN.MODEL.MATCH_COARSE.SKH_ITERS = 3
_CN.MODEL.MATCH_COARSE.SKH_INIT_BIN_SCORE = 1.0
_CN.MODEL.MATCH_COARSE.SKH_PREFILTER = False
