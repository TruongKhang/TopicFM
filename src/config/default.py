...
##############  ↓  MODEL Pipeline  ↓  ##############
_CN.MODEL = CN()
_CN.MODEL.BACKBONE_TYPE = 'convnext'
...
_CN.MODEL.CONVNEXT.INITIAL_DIM = 96
_CN.MODEL.CONVNEXT.BLOCK_DIMS = [96, 128, 256, 384]
