...
cfg.DATASET.MGDPT_IMG_RESIZE = (832, 624) # for training on 11GB mem GPUs
...
cfg.MODEL.MATCH_COARSE.NUM_COARSE_MATCHES = 3600

cfg.TRAINER.CANONICAL_LR = 5e-5
cfg.TRAINER.WARMUP_STEP = 1875  # 3 epochs
cfg.TRAINER.WARMUP_RATIO = 0.1
cfg.TRAINER.MSLR_MILESTONES = [5, 10, 15, 20, 25] # [4, 8, 12, 16, 20, 24]
# pose estimation
