...
cfg.DATASET.MIN_OVERLAP_SCORE_TRAIN = 0.1
...
cfg.DATASET.MGDPT_IMG_RESIZE = (720, 540) # for training on 11GB mem GPUs
...
cfg.TRAINER.CANONICAL_LR = 2e-4
cfg.TRAINER.WARMUP_STEP = 1875  # 3 epochs
cfg.TRAINER.WARMUP_RATIO = 0.1
cfg.TRAINER.MSLR_MILESTONES = [4, 8, 12, 16, 20, 24, 30]
# pose estimation
