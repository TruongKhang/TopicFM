...
cfg.DATASET.TRAIN_LIST_PATH = f"{TRAIN_BASE_PATH}/trainvaltest_list/subset_train_list.txt"
...
cfg.DATASET.VAL_LIST_PATH = cfg.DATASET.TEST_LIST_PATH = f"{TEST_BASE_PATH}/trainvaltest_list/sub_val_list.txt"
cfg.DATASET.MIN_OVERLAP_SCORE_TEST = 0.0   # for both test and val
cfg.DATASET.MGDPT_IMG_RESIZE = (640, 480) # for training on 11GB mem GPUs
cfg.DATASET.MGDPT_IMG_PAD = False
cfg.DATASET.MGDPT_DF = 16

cfg.MODEL.MATCH_COARSE.MATCH_TYPE = 'dual_softmax'
cfg.MODEL.COARSE.N_SAMPLING_TOPICS = 6
cfg.MODEL.MATCH_COARSE.TRAIN_COARSE_PERCENT = 0.1
cfg.MODEL.MATCH_COARSE.NUM_COARSE_MATCHES = 2048

cfg.TRAINER.CANONICAL_LR = 1e-3
cfg.TRAINER.WARMUP_STEP = 1875  # 3 epochs
cfg.TRAINER.WARMUP_RATIO = 0.1
cfg.TRAINER.MSLR_MILESTONES = [5, 10, 15] #, 20, 25, 30] # [4, 8, 12, 16, 20, 24]
# pose estimation
